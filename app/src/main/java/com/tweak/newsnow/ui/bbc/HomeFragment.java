package com.tweak.newsnow.ui.bbc;
...
import com.tweak.newsnow.databinding.FragmentHomeBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_nav_home_to_skyNewsFragment);
            }
        });
        return root;
    }
